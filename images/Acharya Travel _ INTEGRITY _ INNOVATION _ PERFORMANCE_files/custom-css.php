...
.post_header .post_detail, .recent_post_detail, .post_detail a { color: #e12229 !important; }		
...
#menu_wrapper .nav > ul > li a.hover span, #menu_wrapper .nav > ul > li > a:hover span, #menu_wrapper div .nav > li > a.hover span, #menu_wrapper div .nav > li > a:hover span { border-color: #e12229;  }

#menu_wrapper div .nav > li.current-menu-item > a, #menu_wrapper div .nav > li.current-menu-parent > a, #menu_wrapper div .nav > li.current-menu-ancestor > a
{
	color: #e12229;
}
#menu_wrapper div .nav > li.current-menu-item > a span, #menu_wrapper div .nav > li.current-menu-parent > a span, #menu_wrapper div .nav > li.current-menu-ancestor > a span { border-color: #e12229; }
...
a, h1 strong, h2 strong, h3 strong, h4 strong, h5 strong, h6 strong, h7 strong { color:#e12229; }
blockquote { border-color: #e12229; }
::selection { background: #e12229; }

a:hover, a:active, #page_content_wrapper a:hover, #page_content_wrapper a:active { color:#234f9a; }
...
{
	background: #e12229;
	background: rgb(225, 34, 41, 0.9);
	background: rgba(225, 34, 41, 0.9);
}
